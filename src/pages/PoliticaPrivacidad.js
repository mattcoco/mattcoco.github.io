  ...
  return (
    <>
      ...
      <Container xl>
        <hr />
        <h2>1. Objeto</h2>
        <p>Esta Política de Privacidad tiene por objeto dar a conocer el modo en el que recabamos, tratamos y protegemos los datos personales que Usted como Usuario nos ha facilitado, por medio de nuestra página web o blog (en adelante Sitio Web) y decida libremente si desea que los tratemos.</p>
        ...
        <p>Los datos personales identificativos y de contacto que nos facilite por medio de nuestros formularios de contacto, correo electrónico, etc., serán tratados de forma confidencial y solo por personal autorizado por nuestra entidad.</p>
        ...
        <p>Si es Usted cliente, sus datos personales serán tratados con la finalidad de mantener la relación negocial, contractual o comercial, ya sea para la prestación de nuestros servicios, para la gestión contable y de facturación y otros fines a los que nos veamos obligados para dar cumplimiento a las leyes a las que estemos sujetos y para cumplir con dicha relación.</p>
        <p>No enviamos publicidad sin el consentimiento previo de los interesados, salvo a nuestros clientes con relación vigente y siempre sobre los servicios prestados.</p>
        ...
        <p>Si es un solicitante de empleo, trataremos sus datos para incluirle en nuestros procesos de selección y bolsa de trabajo.</p>
        <p>Si es Usted un proveedor, sus datos personales serán tratados con la única finalidad de mantener la relación comercial, ya sea para la prestación de servicios o compra de bienes, para la gestión contable y otros fines a los que nos veamos obligados para dar cumplimiento a dicha relación.</p>
        <p>También se pueden tratar datos con diferentes finalidades al aceptar la instalación de nuestras cookies. Para más información visitar nuestra Política de Cookies.</p>
        ...
        <p>a. Su consentimiento expreso, libre, informado e inequívoco, puesto que le informamos de la presente política de privacidad que tras la lectura de esta y de estar conforme, puede voluntariamente autorizarnos al tratamiento de sus datos mediante la marcación de las casillas dispuestas a tal efecto en nuestros formularios.</p>
        ...
        <p>b. El cumplimiento de la relación comercial o contractual con su persona, en caso de ser cliente, proveedor o que forme parte de nuestro personal.</p>
        <p>c. Dar cumplimiento a nuestras obligaciones legales.</p>
        <p>En el caso de que el usuario sea menor de 14 años, será necesario contar con el consentimiento de los padres, tutores o representante legal, para tratar sus datos.</p>
        <p>El usuario es el único responsable de la veracidad de los datos que nos remite.</p>

        <h2>6. Conservación de datos</h2>
        <p>Los datos personales tratados se conservarán durante el tiempo necesario para cumplir con la finalidad para la que se recaban, durante el tiempo que nos exijan las leyes y mientras sea necesario para depurar posibles responsabilidades derivadas de los tratamientos citados en las finalidades.</p>
        ...
        <p>Si es un cliente y está interesado en la compra/venta o alquiler de inmuebles, sus datos personales podrán ser cedidos a otros clientes que están buscando comprar, vender o arrendar inmuebles. Asimismo, sus datos podrán ser cedidos a entidades terceras por obligación legal (e.g. Agencia Tributaria), o en aquellos casos y entidades necesarias para prestarle nuestros servicios o pagar facturas (e.g. entidades bancarias).</p>
        <p>Si es un proveedor, sus datos personales podrán ser cedidos a entidades terceras por obligación legal (e.g. Agencia Tributaria), o en aquellos casos y entidades necesarias para prestarle nuestros servicios o pagar facturas (e.g. entidades bancarias).</p>
        ...
        <p>Si es un solicitante de empleo, sus datos podrán ser cedidos a otras empresas de nuestro grupo, aunque le solicitaremos autorización para ello.</p>
        <p>Si es Usted un solicitante de información o usuario de nuestro sitio web, sus datos no se cederán a entidades terceras, salvo que legalmente nos veamos obligados a ello.</p>
        ...
        <p>Usted tiene derecho a conocer si nuestra entidad está tratando sus datos personales; por tanto, tiene derecho a acceder a sus datos, rectificarlos si son inexactos o solicitar su supresión cuando los datos ya no sean necesarios, siempre que sea legalmente posible. También puede ejercer su derecho de oposición, limitación o portabilidad si así lo estima conveniente, incluso podrá revocar su consentimiento y para ejercer sus derechos deberá hacerlo por escrito a esther@rogesmar.com, acompañando una copia de su DNI o documento equivalente para para facilitarnos su identificación. Si quien desea ejercer sus derechos es menor de 14 años, podrá hacerlo a través de sus padres, tutores o representante legal. Si desea trasladar alguna sugerencia o consulta sobre el tratamiento de sus datos personales, puede contactar con nuestros consultores de protección de datos, indicando el nombre de nuestra empresa o el nombre comercial:</p> <p>BUSINESS ADAPTER, S.L.</p>
        <p className="text-danger">Ronda Guglielmo Marconi, 11, 26, (Parque Tecnológico) 46980 Paterna (Valencia).</p>
        <p>Formulario de atención al interesado</p>
        <p>Le informamos que Usted tiene derecho a realizar una reclamación ante la Agencia Española de Protección de Datos en: C/ Jorge Juan, 6, 28001 Madrid o en <a href="www.aepd.es">www.aepd.es</a>.</p>
        ...
        <p>Actualizado el 17 de octubre de 2023</p>
